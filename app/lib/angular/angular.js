 ...
 *
 * <pre>
 * var beacon = angular.module('beacon', []);
 * beacon.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://beacon.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://beacon.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('beacon', []).config(function($sceDelegateProvider) {
 ...
 *        'http://beacon.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="beaconController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("beaconController", function beaconController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('beaconWithSceDisabledbeacon', []).config(function($sceProvider) {
